...
const day3 = (type = 'shortest') => {
    ...
    function calculatePath(line) {
        ...
        line.map((movement) => {
            let direction = movement.slice(0, 1);
            let steps = movement.slice(1);
...
// console.log('Closest: ', day3('closest'));
console.log('Shortest: ', day3('shortest'));