...
let testDiagnostics = (p_instructions, input = 1) => {

    const instructions = [...p_instructions];

    for (let index = 0; index < instructions.length;) {
        index = getInstructionDetails(instructions, index, input);
    };

    return instructions;
};

const getInstructionDetails = (instructions, index, input) => {
    ...
    switch (opcode) {
        ...
        case 2:
            ...
            index += 4;
            break;
        // set input value - should be provided as 1st instruction in the program
        case 3:
