...
let testDiagnostics = (p_commands, input = 1) => {

    let commands = [...p_commands];

    return (processOpCodes(commands))
    ...
    function processOpCodes(commands) {
        ...
        for (let i = 0; i < operations.length;) {
            ...
            console.log(`Index: ${i} OpCode: ${operations[i]}`)
            switch (operations[i].toString().length) {
                // process Op Codes with Length = 1
                case 1:
                    switch (operations[i]) {
                        case 0:
                            // console.log('unexpected Op Code: 0');
                            i += 1;
                            break;
                        case 1:
                        ...
                        case 2:
                            ...
                            break;
                        case 3:
                            // console.log('Operation 3: ', input, operations[i + 1]);
                            operations[operations[i + 1]] = input;
                            i += 2;
                            break;
                        case 4:
                            console.log('Operation 4: ', operations[operations[i + 1]]);
                            i += 2;
                            break;
                        // jump-if-true
                        case 5:
                            i = operations[i + 1] != 0 ? operations[i + 1] : i + 2;
                            break;
                        // jump-if-false
                        case 6:
                            i = operations[i + 1] == 0 ? operations[i + 1] : i + 2;
                        ...
                        // less than
                        case 7:
                            operations[operations[i + 3]] = operations[operations[i + 1]] < operations[operations[i + 2]] ? 1 : 0;
                            i += 4;
                            break;
                        // equal to
                        case 8:
                            ...
                            break;
                        default:
                            console.log('invalid op code: ', operations[i])
                            throw new Error('invalid Op Code');
                            i += 1;
                            break;
                    }
                    break;
                // process Op Codes with Length = 2
                case 2:
                    switch (operations[i]) {
                        case 99:
                            i = operations.length;
                ...
                case 3:
                    opcode = Number(operations[i].toString().slice(1));
                    parameter1Mode = Number(operations[i].toString().slice(0, 1));
                    parameter2Mode = 0
                    parameter3Mode = 0;
                    // console.log('Operation 4: ', operations[operations[i + 1]]);
                    ...
                    switch (parameter1Mode) {
                        case 0:
                            operand1 = operations[operations[i + 1]]
                            break;
                        case 1:
                            operand1 = operations[i + 1]
                            break;
                        default:
                            break;
                    }

                    operand2 = operations[operations[i + 2]];

                    switch (opcode) {
                        case 1:
                            operations[operations[i + 3]] = operand1 + operand2;
                            i += 4;
                            break;
                        case 2:
                            operations[operations[i + 3]] = operand1 * operand2;
                        ...
                        case 4:
                            console.log('Operation 4: ', operations[operations[i + 1]]);
                            console.log('Operation 4: ', operand1);
                            i += 2;
                            break;
                        // jump-if-true
                        case 5:
                            i = operand1 != 0 ? operand2 : i + 2;
                            break;
                        // jump-if-false
                        case 6:
                            i = operand1 == 0 ? operand2 : i + 2;
                        ...
                        // less than
                        case 7:
                            operations[operations[i + 3]] = operand1 < operand2 ? 1 : 0;
                            i += 4;
                            break;
                        // equal to
                        case 8:
                    ...
                    break;
                // process Op Codes with Length = 4
                case 4:
                    opcode = Number(operations[i].toString().slice(2));
                    parameter1Mode = Number(operations[i].toString().slice(1, 2));
                    parameter2Mode = Number(operations[i].toString().slice(0, 1));
                    parameter3Mode = 0;
